...
const getBeer = (nameQuery) => {
    ...
    $.ajax({
        ...
        for (let i = 0; i <= beerData.data.length; i++) {
            ...
            let thisBeer = '<div class="col s12 m6"><div class="card"><div class="card-image"><div id="accordion"><a class="btn-floating halfway-fab waves-effect waves-light red"><i class="material-icons">add</i></a><div class="card-content"><div>' + (beerData.data[i].name)  + '</div><div>' + (beerData.data[i].style.description) 
